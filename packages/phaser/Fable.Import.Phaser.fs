...
module Phaser =
    ...
    and [<AllowNullLiteral>] [<Import("BitmapText","Phaser")>] BitmapText(game: Phaser.Game, x: float, y: float, font: string, ?text: string, ?size: float, ?align: string) =
        ...
        member __.body with get(): U4<undefined.Body, undefined.Body, undefined.Body, obj> = jsNative and set(v: U4<undefined.Body, undefined.Body, undefined.Body, obj>): unit = jsNative
    ...
    and [<AllowNullLiteral>] [<Import("Game","Phaser")>] Game(config: IGameConfig) =
        ...
        member __.debug with get(): undefined.Debug = jsNative and set(v: undefined.Debug): unit = jsNative
    ...
    and [<AllowNullLiteral>] [<Import("GameObjectCreator","Phaser")>] GameObjectCreator(game: Phaser.Game) =
        ...
        member __.emitter(?x: float, ?y: float, ?maxParticles: float): undefined.Emitter = jsNative
    ...
    and [<AllowNullLiteral>] [<Import("Group","Phaser")>] Group(game: Phaser.Game, ?parent: PIXI.DisplayObjectContainer, ?name: string, ?addToStage: bool, ?enableBody: bool, ?physicsBodyType: float) =
        interface PIXI.DisplayObjectContainer
    ...
    and [<AllowNullLiteral>] [<Import("Particles","Phaser")>] Particles(game: Phaser.Game) =
        ...
        member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
        member __.ID with get(): float = jsNative and set(v: float): unit = jsNative
        member __.add(emitter: undefined.Emitter): undefined.Emitter = jsNative
        member __.remove(emitter: undefined.Emitter): unit = jsNative
        member __.update(): unit = jsNative
    ...
    and [<AllowNullLiteral>] [<Import("Physics","Phaser")>] Physics(game: Phaser.Game, ?config: obj) =
        ...
        member __.arcade with get(): undefined.Arcade = jsNative and set(v: undefined.Arcade): unit = jsNative
        member __.config with get(): obj = jsNative and set(v: obj): unit = jsNative
        member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
        member __.ninja with get(): undefined.Ninja = jsNative and set(v: undefined.Ninja): unit = jsNative
        member __.p2 with get(): undefined.P2 = jsNative and set(v: undefined.P2): unit = jsNative
    ...
    and [<AllowNullLiteral>] [<Import("SpriteBatch","Phaser")>] SpriteBatch(game: Phaser.Game, parent: PIXI.DisplayObjectContainer, ?name: string, ?addedToStage: bool) =
        inherit Phaser.Group()
        member __.``type`` with get(): float = jsNative and set(v: float): unit = jsNative
    ...
    module Particles =
        module Arcade =
            type [<AllowNullLiteral>] [<Import("Particles.Arcade.Emitter","Phaser")>] Emitter(game: Phaser.Game, ?x: float, ?y: float, ?maxParticles: float) =
                ...
                member __.x with get(): float = jsNative and set(v: float): unit = jsNative
                member __.y with get(): float = jsNative and set(v: float): unit = jsNative
                member __.at(``object``: obj): undefined.Emitter = jsNative
                member __.emitParticle(?x: float, ?y: float, ?key: obj, ?frame: U2<string, float>): bool = jsNative
                member __.explode(?lifespan: float, ?quantity: float): undefined.Emitter = jsNative
                member __.flow(?lifespan: float, ?frequency: float, ?quantity: float, ?total: float, ?immediate: bool): undefined.Emitter = jsNative
                member __.kill(): undefined.Emitter = jsNative
                member __.makeParticles(keys: obj, ?frames: obj, ?quantity: float, ?collide: bool, ?collideWorldBounds: bool): undefined.Emitter = jsNative
                member __.reset(x: float, y: float, ?health: float): Phaser.Particles = jsNative
                member __.setAlpha(?min: float, ?max: float, ?rate: float, ?ease: Func<float, float>, ?yoyo: bool): undefined.Emitter = jsNative
                member __.setRotation(?min: float, ?max: float): undefined.Emitter = jsNative
                member __.setScale(?minX: float, ?maxX: float, ?minY: float, ?maxY: float, ?rate: float, ?ease: Func<float, float>, ?yoyo: bool): undefined.Emitter = jsNative
                member __.setSize(width: float, height: float): undefined.Emitter = jsNative
                member __.setXSpeed(min: float, max: float): undefined.Emitter = jsNative
                member __.setYSpeed(min: float, max: float): undefined.Emitter = jsNative
                member __.start(?explode: bool, ?lifespan: float, ?frequency: float, ?quantity: float, ?forceQuantity: bool): undefined.Emitter = jsNative
                member __.update(): unit = jsNative
                member __.revive(): undefined.Emitter = jsNative
    ...
    module Physics =
        type [<AllowNullLiteral>] [<Import("Physics.Arcade","Phaser")>] Arcade(game: Phaser.Game) =
            ...
            member __.computeVelocity(axis: float, body: undefined.Body, velocity: float, acceleration: float, drag: float, ?max: float): float = jsNative
            ...
            member __.getOverlapX(body1: undefined.Body, body2: undefined.Body): float = jsNative
            member __.getOverlapY(body1: undefined.Body, body2: undefined.Body): float = jsNative
            member __.intersects(body1: undefined.Body, body2: undefined.Body): bool = jsNative
            ...
            member __.processTileSeparationX(body: undefined.Body, x: float): bool = jsNative
            member __.processTileSeparationY(body: undefined.Body, y: float): unit = jsNative
            member __.setBounds(x: float, y: float, width: float, height: float): unit = jsNative
            member __.setBoundsToWorld(): unit = jsNative
            member __.separate(body1: undefined.Body, body2: undefined.Body, ?processCallback: Function, ?callbackContext: obj, ?overlapOnly: bool): bool = jsNative
            member __.separateX(body1: undefined.Body, body2: undefined.Body, overlapOnly: bool): bool = jsNative
            member __.separateY(body1: undefined.Body, body2: undefined.Body, overlapOnly: bool): bool = jsNative
            member __.separateTile(i: float, body: undefined.Body, tile: Phaser.Tile): bool = jsNative
            member __.sort(group: Phaser.Group): unit = jsNative
            member __.tileCheckX(body: undefined.Body, tile: Phaser.Tile): float = jsNative
            member __.tileCheckY(body: undefined.Body, tile: Phaser.Tile): float = jsNative
            member __.updateMotion(body: undefined.Body): unit = jsNative
        ...
        and [<AllowNullLiteral>] [<Import("Physics.Ninja","Phaser")>] Ninja(game: Phaser.Game) =
            ...
            member __.collide(object1: obj, object2: obj, ?collideCallback: Function, ?processCallback: Function, ?callbackContext: obj): bool = jsNative
            member __.convertTilemap(map: Phaser.Tilemap, layer: obj, slopeMap: obj): ResizeArray<undefined.Tile> = jsNative
        ...
        and [<AllowNullLiteral>] [<Import("Physics.P2","Phaser")>] P2(game: Phaser.Game, ?config: obj) =
            ...
            member __.boundsCollidesWith with get(): ResizeArray<undefined.Body> = jsNative and set(v: ResizeArray<undefined.Body>): unit = jsNative
            member __.boundsCollisionGroup with get(): undefined.CollisionGroup = jsNative and set(v: undefined.CollisionGroup): unit = jsNative
            member __.config with get(): obj = jsNative and set(v: obj): unit = jsNative
            member __.callbackContext with get(): obj = jsNative and set(v: obj): unit = jsNative
            member __.collisionGroups with get(): ResizeArray<undefined.CollisionGroup> = jsNative and set(v: ResizeArray<undefined.CollisionGroup>): unit = jsNative
            member __.contactMaterial with get(): undefined.ContactMaterial = jsNative and set(v: undefined.ContactMaterial): unit = jsNative
            member __.emitImpactEvent with get(): bool = jsNative and set(v: bool): unit = jsNative
            member __.everythingCollisionGroup with get(): undefined.CollisionGroup = jsNative and set(v: undefined.CollisionGroup): unit = jsNative
            ...
            member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
            member __.gravity with get(): undefined.InversePointProxy = jsNative and set(v: undefined.InversePointProxy): unit = jsNative
            member __.materials with get(): ResizeArray<undefined.Material> = jsNative and set(v: ResizeArray<undefined.Material>): unit = jsNative
            member __.nothingCollisionGroup with get(): undefined.CollisionGroup = jsNative and set(v: undefined.CollisionGroup): unit = jsNative
            ...
            member __.world with get(): p2.World = jsNative and set(v: p2.World): unit = jsNative
            member __.addBody(body: undefined.Body): bool = jsNative
            member __.addContactMaterial(material: undefined.ContactMaterial): undefined.ContactMaterial = jsNative
            member __.addConstraint(``constraint``: 'T): 'T = jsNative
            member __.addSpring(spring: undefined.Spring): undefined.Spring = jsNative
            member __.beginContactHandler(``event``: obj): unit = jsNative
            member __.clear(): unit = jsNative
            member __.clearTilemapLayerBodies(map: Phaser.Tilemap, ?layer: obj): unit = jsNative
            member __.convertCollisionObjects(map: Phaser.Tilemap, ?layer: obj, ?addToWorld: bool): ResizeArray<undefined.Body> = jsNative
            member __.convertTilemap(map: Phaser.Tilemap, ?layer: obj, ?addToWorld: Boolean, ?optimize: bool): ResizeArray<undefined.Body> = jsNative
            member __.createBody(x: float, y: float, mass: float, ?addToWorld: bool, ?options: p2.BodyOptions, ?data: ResizeArray<ResizeArray<float>>): undefined.Body = jsNative
            member __.createBody(x: float, y: float, mass: float, ?addToWorld: bool, ?options: p2.BodyOptions, ?data: ResizeArray<float>): undefined.Body = jsNative
            member __.createCollisionGroup(?group: Phaser.Group): undefined.CollisionGroup = jsNative
            member __.createCollisionGroup(?group: Phaser.Sprite): undefined.CollisionGroup = jsNative
            member __.createContactMaterial(materialA: undefined.Material, materialB: undefined.Material, ?options: p2.ContactMaterialOptions): undefined.ContactMaterial = jsNative
            member __.createDistanceConstraint(bodyA: obj, bodyB: obj, distance: float, ?localAnchorA: ResizeArray<float>, ?localAnchorB: ResizeArray<float>, ?maxForce: float): undefined.DistanceConstraint = jsNative
            member __.createGearConstraint(bodyA: obj, bodyB: obj, ?angle: float, ?ratio: float): undefined.GearConstraint = jsNative
            member __.createLockConstraint(bodyA: obj, bodyB: obj, ?offset: ResizeArray<float>, ?angle: float, ?maxForce: float): undefined.LockConstraint = jsNative
            member __.createMaterial(?name: string, ?body: undefined.Body): undefined.Material = jsNative
            member __.createParticle(x: float, y: float, mass: float, ?addToWorld: bool, ?options: p2.BodyOptions, ?data: ResizeArray<ResizeArray<float>>): undefined.Body = jsNative
            member __.createParticle(x: float, y: float, mass: float, ?addToWorld: bool, ?options: p2.BodyOptions, ?data: ResizeArray<float>): undefined.Body = jsNative
            member __.createPrismaticConstraint(body: obj, bodyB: obj, ?lockRotation: bool, ?anchorA: ResizeArray<float>, ?anchorB: ResizeArray<float>, ?axis: Float32Array, ?maxForce: float): undefined.PrismaticConstraint = jsNative
            member __.createRevoluteConstraint(bodyA: obj, pivotA: ResizeArray<float>, bodyB: obj, pivotB: ResizeArray<float>, ?maxForce: float, ?worldPivot: ResizeArray<float>): undefined.RevoluteConstraint = jsNative
            member __.createRotationalSpring(bodyA: obj, bodyB: obj, ?restAngle: float, ?stiffness: float, ?damping: float): p2.RotationalSpring = jsNative
            member __.createSpring(bodyA: obj, bodyB: obj, ?restLength: float, ?stiffness: float, ?damping: float, ?worldA: ResizeArray<float>, ?worldB: ResizeArray<float>, ?localA: ResizeArray<float>, ?localB: ResizeArray<float>): undefined.Spring = jsNative
            member __.destroy(): unit = jsNative
            ...
            member __.getBodies(): ResizeArray<undefined.Body> = jsNative
            member __.getBody(``object``: obj): undefined.Body = jsNative
            member __.getConstraints(): ResizeArray<p2.Constraint> = jsNative
            member __.getSprings(): ResizeArray<undefined.Spring> = jsNative
            member __.getContactMaterial(materialA: undefined.Material, materialB: undefined.Material): undefined.ContactMaterial = jsNative
            member __.hitTest(worldPoint: Phaser.Point, ?bodies: ResizeArray<obj>, ?precision: float, ?filterStatic: bool): ResizeArray<undefined.Body> = jsNative
            ...
            member __.removeBody(body: undefined.Body): undefined.Body = jsNative
            member __.removeBodyNextStep(body: undefined.Body): unit = jsNative
            member __.removeConstraint(``constraint``: 'T): 'T = jsNative
            member __.removeContactMaterial(material: undefined.ContactMaterial): undefined.ContactMaterial = jsNative
            member __.removeSpring(spring: undefined.Spring): undefined.Spring = jsNative
            member __.reset(): unit = jsNative
            member __.resume(): unit = jsNative
            ...
            member __.setCollisionGroup(``object``: obj, group: undefined.CollisionGroup): unit = jsNative
            member __.setImpactEvents(state: bool): unit = jsNative
            member __.setMaterial(material: undefined.Material, ?bodies: ResizeArray<undefined.Body>): unit = jsNative
            member __.setPostBroadphaseCallback(callback: Function, context: obj): unit = jsNative
            member __.setWorldMaterial(material: undefined.Material, ?left: bool, ?right: bool, ?top: bool, ?bottom: bool): unit = jsNative
        ...
        module Arcade =
            type [<AllowNullLiteral>] [<Import("Physics.Arcade.Body","Phaser")>] Body(sprite: Phaser.Sprite) =
                ...
                member __.preUpdate(): unit = jsNative
                member __.postUpdate(): unit = jsNative
                member __.render(context: obj, body: undefined.Body, ?color: string, ?filled: bool): unit = jsNative
                member __.renderBodyInfo(debug: undefined.Debug, body: undefined.Body): unit = jsNative
        ...
        module Ninja =
            type [<AllowNullLiteral>] [<Import("Physics.Ninja.Body","Phaser")>] Body(system: undefined.Ninja, sprite: Phaser.Sprite, ?``type``: float, ?id: float, ?radius: float, ?x: float, ?y: float, ?width: float, ?height: float) =
                member __.aabb with get(): undefined.AABB = jsNative and set(v: undefined.AABB): unit = jsNative
                member __.angle with get(): float = jsNative and set(v: float): unit = jsNative
                member __.bottom with get(): float = jsNative and set(v: float): unit = jsNative
                member __.bounce with get(): float = jsNative and set(v: float): unit = jsNative
                member __.checkCollision with get(): undefined.FaceChoices = jsNative and set(v: undefined.FaceChoices): unit = jsNative
                member __.circle with get(): undefined.Circle = jsNative and set(v: undefined.Circle): unit = jsNative
                member __.collideWorldBounds with get(): bool = jsNative and set(v: bool): unit = jsNative
                ...
                member __.right with get(): float = jsNative and set(v: float): unit = jsNative
                member __.sprite with get(): Phaser.Sprite = jsNative and set(v: Phaser.Sprite): unit = jsNative
                member __.system with get(): undefined.Ninja = jsNative and set(v: undefined.Ninja): unit = jsNative
                member __.tile with get(): undefined.Tile = jsNative and set(v: undefined.Tile): unit = jsNative
                member __.touching with get(): undefined.FaceChoices = jsNative and set(v: undefined.FaceChoices): unit = jsNative
                member __.``type`` with get(): float = jsNative and set(v: float): unit = jsNative
                member __.shape with get(): obj = jsNative and set(v: obj): unit = jsNative
                member __.speed with get(): float = jsNative and set(v: float): unit = jsNative
                member __.velocity with get(): Phaser.Point = jsNative and set(v: Phaser.Point): unit = jsNative
                member __.wasTouching with get(): undefined.FaceChoices = jsNative and set(v: undefined.FaceChoices): unit = jsNative
                member __.width with get(): float = jsNative and set(v: float): unit = jsNative
                member __.x with get(): float = jsNative and set(v: float): unit = jsNative
                member __.y with get(): float = jsNative and set(v: float): unit = jsNative
                member __.deltaAbsX(): float = jsNative
            ...
            and [<AllowNullLiteral>] [<Import("Physics.Ninja.AABB","Phaser")>] AABB(body: undefined.Body, x: float, y: float, width: float, height: float) =
                ...
                member __.body with get(): undefined.Body = jsNative and set(v: undefined.Body): unit = jsNative
                member __.height with get(): float = jsNative and set(v: float): unit = jsNative
                ...
                member __.collideAABBVsAABB(aabb: undefined.AABB): bool = jsNative
                member __.collideAABBVsTile(tile: undefined.Tile): bool = jsNative
                member __.destroy(): unit = jsNative
                ...
                member __.resolveTile(x: float, y: float, body: undefined.AABB, tile: undefined.Tile): bool = jsNative
                member __.reverse(): unit = jsNative

            and [<AllowNullLiteral>] [<Import("Physics.Ninja.Circle","Phaser")>] Circle(body: undefined.Body, x: float, y: float, radius: float) =
                member __.COL_NONE with get(): float = jsNative and set(v: float): unit = jsNative
                member __.COL_AXIS with get(): float = jsNative and set(v: float): unit = jsNative
                member __.COL_OTHER with get(): float = jsNative and set(v: float): unit = jsNative
                member __.body with get(): undefined.Body = jsNative and set(v: undefined.Body): unit = jsNative
                ...
                member __.xw with get(): float = jsNative and set(v: float): unit = jsNative
                member __.yw with get(): float = jsNative and set(v: float): unit = jsNative
                member __.collideCircleVsTile(tile: undefined.Tile): bool = jsNative
                member __.collideWorldBounds(): unit = jsNative
                member __.destroy(): unit = jsNative
                ...
                member __.reportCollisionVsWorld(px: float, py: float, dx: float, dy: float, obj: obj): unit = jsNative
                member __.reportCollisionVsBody(px: float, py: float, dx: float, dy: float, obj: obj): unit = jsNative
                member __.resolveCircleTile(x: float, y: float, oH: float, oV: float, obj: undefined.Circle, t: undefined.Tile): bool = jsNative

            and [<AllowNullLiteral>] TileType =
                | TYPE_EMPTY = 0
                | TYPE_FULL = 1
                | TYPE_45DEG = 2
                | TYPE_CONCAVE = 3
            ...
            and [<AllowNullLiteral>] [<Import("Physics.Ninja.Tile","Phaser")>] Tile(body: undefined.Body, x: float, y: float, width: float, height: float, ?``type``: float) =
                member __.body with get(): undefined.Body = jsNative and set(v: undefined.Body): unit = jsNative
                member __.bottom with get(): float = jsNative and set(v: float): unit = jsNative
                ...
                member __.rotation with get(): float = jsNative and set(v: float): unit = jsNative
                member __.system with get(): undefined.Ninja = jsNative and set(v: undefined.Ninja): unit = jsNative
                member __.``type`` with get(): undefined.TileType = jsNative and set(v: undefined.TileType): unit = jsNative
                member __.velocity with get(): Phaser.Point = jsNative and set(v: Phaser.Point): unit = jsNative
                member __.width with get(): float = jsNative and set(v: float): unit = jsNative
                member __.xw with get(): float = jsNative and set(v: float): unit = jsNative
                member __.yw with get(): float = jsNative and set(v: float): unit = jsNative
        ...
        module P2 =
            type [<AllowNullLiteral>] [<Import("Physics.P2.Body","Phaser")>] Body(game: Phaser.Game, ?sprite: Phaser.Sprite, ?x: float, ?y: float, ?mass: float) =
                ...
                member __.angularVelocity with get(): float = jsNative and set(v: float): unit = jsNative
                member __.collidesWith with get(): ResizeArray<undefined.CollisionGroup> = jsNative and set(v: ResizeArray<undefined.CollisionGroup>): unit = jsNative
                member __.collideWorldBounds with get(): bool = jsNative and set(v: bool): unit = jsNative
                ...
                member __.debug with get(): bool = jsNative and set(v: bool): unit = jsNative
                member __.debugBody with get(): undefined.BodyDebug = jsNative and set(v: undefined.BodyDebug): unit = jsNative
                ...
                member __.force with get(): undefined.InversePointProxy = jsNative and set(v: undefined.InversePointProxy): unit = jsNative
                ...
                member __.``type`` with get(): float = jsNative and set(v: float): unit = jsNative
                member __.velocity with get(): undefined.InversePointProxy = jsNative and set(v: undefined.InversePointProxy): unit = jsNative
                member __.world with get(): undefined.P2 = jsNative and set(v: undefined.P2): unit = jsNative
                member __.x with get(): float = jsNative and set(v: float): unit = jsNative
                member __.y with get(): float = jsNative and set(v: float): unit = jsNative
                ...
                member __.addPhaserPolygon(key: string, ``object``: string): undefined.FixtureList = jsNative
                ...
                member __.createGroupCallback(group: undefined.CollisionGroup, callback: Function, callbackContext: obj): unit = jsNative
                member __.destroy(): unit = jsNative
                ...
                member __.setCollisionGroup(group: undefined.CollisionGroup, ?shape: p2.Shape): unit = jsNative
                ...
                member __.setMaterial(material: undefined.Material, ?shape: p2.Shape): unit = jsNative
            ...
            and [<AllowNullLiteral>] [<Import("Physics.P2.BodyDebug","Phaser")>] BodyDebug(game: Phaser.Game, body: undefined.Body, settings: obj) =
                inherit Phaser.Group()
                member __.body with get(): undefined.Body = jsNative and set(v: undefined.Body): unit = jsNative
            ...
            and [<AllowNullLiteral>] [<Import("Physics.P2.DistanceConstraint","Phaser")>] DistanceConstraint(world: undefined.P2, bodyA: undefined.Body, bodyB: undefined.Body, distance: float, maxForce: float) =
            ...
            and [<AllowNullLiteral>] [<Import("Physics.P2.GearConstraint","Phaser")>] GearConstraint(world: undefined.P2, bodyA: undefined.Body, bodyB: undefined.Body, ?angle: float, ?ratio: float) =
                interface p2.GearConstraint
                member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
                member __.world with get(): undefined.P2 = jsNative and set(v: undefined.P2): unit = jsNative

            and [<AllowNullLiteral>] [<Import("Physics.P2.InversePointProxy","Phaser")>] InversePointProxy(world: undefined.P2, destination: obj) =
                member __.x with get(): float = jsNative and set(v: float): unit = jsNative
                member __.y with get(): float = jsNative and set(v: float): unit = jsNative
            ...
            and [<AllowNullLiteral>] [<Import("Physics.P2.LockConstraint","Phaser")>] LockConstraint(world: undefined.P2, bodyA: undefined.Body, bodyB: undefined.Body, ?offset: ResizeArray<float>, ?angle: float, ?maxForce: float) =
            ...
            and [<AllowNullLiteral>] [<Import("Physics.P2.PointProxy","Phaser")>] PointProxy(world: undefined.P2, destination: obj) =
                member __.x with get(): float = jsNative and set(v: float): unit = jsNative
                member __.y with get(): float = jsNative and set(v: float): unit = jsNative
                member __.mx with get(): float = jsNative and set(v: float): unit = jsNative
                member __.my with get(): float = jsNative and set(v: float): unit = jsNative

            and [<AllowNullLiteral>] [<Import("Physics.P2.PrismaticConstraint","Phaser")>] PrismaticConstraint(world: undefined.P2, ?bodyA: undefined.Body, ?bodyB: undefined.Body, ?lockRotation: bool, ?anchorA: ResizeArray<float>, ?anchorB: ResizeArray<float>, ?axis: ResizeArray<float>, ?maxForce: float) =
                interface p2.PrismaticConstraint
                member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
                member __.world with get(): undefined.P2 = jsNative and set(v: undefined.P2): unit = jsNative

            and [<AllowNullLiteral>] [<Import("Physics.P2.RevoluteConstraint","Phaser")>] RevoluteConstraint(world: undefined.P2, bodyA: undefined.Body, pivotA: ResizeArray<float>, bodyB: undefined.Body, pivotB: ResizeArray<float>, ?maxForce: float) =
                interface p2.RevoluteConstraint
                member __.game with get(): Phaser.Game = jsNative and set(v: Phaser.Game): unit = jsNative
                member __.world with get(): undefined.P2 = jsNative and set(v: undefined.P2): unit = jsNative

            and [<AllowNullLiteral>] [<Import("Physics.P2.Spring","Phaser")>] Spring(world: undefined.P2, bodyA: undefined.Body, bodyB: undefined.Body, ?restLength: float, ?stiffness: float, ?damping: float, ?worldA: ResizeArray<float>, ?worldB: ResizeArray<float>, ?localA: ResizeArray<float>, ?localB: ResizeArray<float>) =
    ...
    module Plugin =
        ...
        and [<AllowNullLiteral>] [<Import("Plugin.AStar","Phaser")>] AStar(parent: PIXI.DisplayObject) =
            ...
            member __.parent with get(): PIXI.DisplayObject = jsNative and set(v: PIXI.DisplayObject): unit = jsNative
            member __.version with get(): string = jsNative and set(v: string): unit = jsNative
            member __.findPath(startPoint: Phaser.Point, goalPoint: Phaser.Point): undefined.AStarPath = jsNative
            member __.isWalkable(x: float, y: float): bool = jsNative
            member __.setAStarMap(map: Phaser.Tilemap, layerName: string, tilesetName: string): undefined.AStar = jsNative
        ...
        and [<AllowNullLiteral>] [<Import("Plugin.Juicy","Phaser")>] Juicy(game: Phaser.Game) =
            inherit Phaser.Plugin()
            member __.createScreenFlash(?color: string): undefined.ScreenFlash = jsNative
            member __.createTrail(?length: float, ?color: float): undefined.Trail = jsNative
        ...
        module AStar =
            type [<AllowNullLiteral>] [<Import("Plugin.AStar.AStarNode","Phaser")>] AStarNode(x: float, y: float, isWalkable: bool) =
                ...
                member __.h with get(): float = jsNative and set(v: float): unit = jsNative
                member __.f with get(): float = jsNative and set(v: float): unit = jsNative
                member __.parent with get(): undefined.AStarNode = jsNative and set(v: undefined.AStarNode): unit = jsNative
            ...
            and [<AllowNullLiteral>] [<Import("Plugin.AStar.AStarPath","Phaser")>] AStarPath(nodes: ResizeArray<undefined.AStarNode>, start: undefined.AStarNode, goal: undefined.AStarNode) =
                member __.nodes with get(): ResizeArray<undefined.AStarNode> = jsNative and set(v: ResizeArray<undefined.AStarNode>): unit = jsNative
                member __.start with get(): undefined.AStarNode = jsNative and set(v: undefined.AStarNode): unit = jsNative
                member __.goal with get(): undefined.AStarNode = jsNative and set(v: undefined.AStarNode): unit = jsNative
                member __.visited with get(): ResizeArray<undefined.AStarNode> = jsNative and set(v: ResizeArray<undefined.AStarNode>): unit = jsNative
    ...
    module Utils =
        type [<AllowNullLiteral>] [<Import("Utils.Debug","Phaser")>] Debug(game: Phaser.Game) =
            ...
            member __.AStar(astar: undefined.AStar, x: float, y: float, showVisited: bool): unit = jsNative
            member __.boot(): unit = jsNative
